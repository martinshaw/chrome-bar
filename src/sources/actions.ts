import { SearchSelectorElementType, ShortcutEntryListType, getElementsFromFrame, searchSelector } from "../script";
    ...
    return {
        ...
        'add-url-to-your-marchive': {
            ...
            'performAction': () => {
                ...
                if (url == null || (url.startsWith('http://') || url.startsWith('https://')) === false) return;
